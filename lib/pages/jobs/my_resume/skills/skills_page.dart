...
class _SkillsPageState extends ConsumerState<SkillsPage> {
  ...
  void setupPage() async {
    await futureAwait(duration: 1500, () {
      if(mounted) {
        ...
        final provider = getSkillsDetailsProvider(ref, widget.id ?? '0');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: labels.label('Skills', fontSize: 20, fontWeight: FontWeight.w500,),
        titleSpacing: 6,
      ),
                  ...
                  children: [
                    ...
                    forms.labelFormFields(
                      ...
                      onTap: () => showActionSheet(context, [
                        MoreTypeInfo('basic', 'Basic', null, null, () {
                          updateNewMap('level', 'basic');
                          setState(() {valueController.text = 'Basic';});
                        }),
                        ...
                        MoreTypeInfo('expert', 'Expert', null, null, () {
                          updateNewMap('level', 'expert');
                          setState(() {valueController.text = 'Expert';});
                        }),
                      ]),
                    ),
                    SizedBox(height: doubleHeight,),
